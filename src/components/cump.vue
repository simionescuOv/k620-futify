<template>
  <div>
    <v-container>
      <div class="row">
        <!-- <div class="col-md-3 col-sm-3 col-xs-12 amber darken-1"        > -->
        <div class="col-md-3  col-xs-12 amber darken-1"        >
          <v-card outlined>
...
<unupanel></unupanel>
        ...
        <!-- <div class="col-md-9 col-sm-9 col-xs-12 pink lighten-4" > -->
        <div class="col-md-9  col-xs-12 pink lighten-4" >
...
<script>
import unupanel from '@/components/unuPanel'
    export default {
       components: {
             unupanel
        },
